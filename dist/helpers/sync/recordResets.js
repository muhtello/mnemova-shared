...
exports.syncRecordResets = syncRecordResets;
// ─── syncRecordResets ───────────────────────────────────────────────────────────
...
async function syncRecordResets(client, resets, userId) {
    var _a;
    const syncedDeckIds = [];
    let firstError = null;
    for (const reset of resets) {
        ...
        if (reset.exerciseIds.length > 0) {
            ...
            resetError = (_a = resetError !== null && resetError !== void 0 ? resetError : cardResult.error) !== null && _a !== void 0 ? _a : attemptResult.error;
        }
        // Only mark synced when the whole wipe succeeded — a partial failure stays queued.
        if (resetError) {
            firstError = firstError !== null && firstError !== void 0 ? firstError : resetError.message;
            continue;
        }
